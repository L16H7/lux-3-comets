...
def make_train(config: Config):
    ...
    def v_reset(meta_keys, meta_env_params):
        ...
        p0_representations, p1_representations = create_agent_representations(
            ...
            p0_points_map=jnp.ones((n_envs, config.map_width, config.map_height), dtype=jnp.float32) * -1,
            p1_points_map=jnp.ones((n_envs, config.map_width, config.map_height), dtype=jnp.float32) * -1,
