...
class Agent():
    def __init__(self, player: str, env_cfg) -> None:
        ...
        self.unit_sap_range = jnp.array([[[env_cfg["unit_sap_range"]]]]).repeat(16, 1)
        self.unit_move_cost = jnp.array([[[env_cfg["unit_move_cost"]]]]).repeat(16, 1)
        self.unit_sap_cost = jnp.array([[[env_cfg["unit_sap_cost"]]]]).repeat(16, 1)
        self.unit_sensor_range = jnp.array([[[env_cfg["unit_sensor_range"]]]]).repeat(16, 1)
